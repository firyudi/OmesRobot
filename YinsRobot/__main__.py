...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an ʙᴏᴛ ᴍᴀɴᴀɢᴇʀ + ᴍᴜsɪᴄ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡᴇʟʟ [✨](https://telegra.ph/file/9ee069dd82859e2bc98a9.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About RAMBEL", callback_data="yins_"),
    ],
    [
...
def yins_about_callback(update, context):
    ...
    if query.data == "yins_":
        query.message.edit_text(
            ...
            "\n\n_RAMBEL licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for RAMBEL.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
