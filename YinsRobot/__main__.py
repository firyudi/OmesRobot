...
PM_START_TEXT = """
*Hello {} !*
✪ I'm an ʙᴏᴛ ᴍᴀɴᴀɢᴇʀ + ᴍᴜsɪᴄ ᴛᴏ ᴍᴀɴᴀɢᴇ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴡᴇʟʟ [✨](https://te.legra.ph/file/b79197c46db56a987571d.jpg)
────────────────────────
× *Uptime:* `{}`
× `{}` *users, across* `{}` *chats.*
────────────────────────
...
buttons = [
    [
        InlineKeyboardButton(text="About Omes🤖", callback_data="yins_"),
    ],
    [
...
DONATE_STRING = """Heya, glad to hear you want to donate!
 You can support the project by contacting @omesnakal \
...
def yins_about_callback(update, context):
    ...
    if query.data == "yins_":
        query.message.edit_text(
            text="๏ I'm *OMESROBOT*, a powerful group management bot built to help you manage your group easily."
            ...
            "\n\n_OMESROBOT licensed under the GNU General Public License v3.0_"
            "\n\n Click on button bellow to get basic help for OMESROBOT.",
            parse_mode=ParseMode.MARKDOWN,
            disable_web_page_preview=True,
            reply_markup=InlineKeyboardMarkup(
                [
        ...
        query.message.edit_text(
            ...
            "\nCongragulations, OMESROBOT now ready to manage your group."
            "\n\n*Admin Tools*"
        ...
        query.message.edit_text(
            ...
            "\nJoin My Support Group/Channel for see or report a problem on OMESROBOT.",
            parse_mode=ParseMode.MARKDOWN,
            reply_markup=InlineKeyboardMarkup(
                [
                 [
    ...
    if SUPPORT_CHAT is not None and isinstance(SUPPORT_CHAT, str):
        try:
            dispatcher.bot.sendMessage(
                f"@{SUPPORT_CHAT}", 
                "✨ Hai, OMESROBOT Berhasil Diaktifkan",
                parse_mode=ParseMode.MARKDOWN
            )
        except Unauthorized:
            LOGGER.warning(
